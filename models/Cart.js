...
class Cart {
    ...
    static async update(member_id, product_id, quantity){
        ...
        const sql = ` UPDATE  carts  SET quantity=? WHERE member_id=? AND product_id`;
        const [r] = await db.query(sql,[quantity,member_id, product_id]);
        return r;
    }
    ...
    static async remove(member_id, product_id){
        ...
        const sql = `DELETE FROM carts WHERE member_id=? AND product_id=?`;
    ...
    static async clear(member_id){
        ...
        const sql = `DELETE FROM carts WHERE member_id=?`;
